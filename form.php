...
Crisp Digital India Private Limited" data-errormessage-value-missing="Advertiser /company name is required*" data-prompt-position="bottomLeft" >
            ...
            <div class="form-row">
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control validate[required]" name="city"  placeholder="Bhubaneswar." data-errormessage-value-missing="City is required*" data-prompt-position="bottomLeft">
                  </div>
                   <div class="form-group col-md-6">
                      <label class="label" for="pin">4. PIN CODE</label>
                      <input type="text" class="form-control validate[required]" name="pin"  placeholder="741501.  " data-errormessage-value-missing="Pin is required*" data-prompt-position="bottomLeft">
                  </div>
            </div>
           ...
           <div class="form-row">
                 <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control validate[required]" name="primary_phone" placeholder="9812345678" data-errormessage-value-missing="Primary phone no is required*" data-prompt-position="bottomLeft">
                 </div>
                 <div class="form-group col-md-6">
                      <label class="label" for="mobile">6. mobile</label>
                      <input type="text" class="form-control validate[required]" name="mobile" id="" placeholder="9812345678" data-errormessage-value-missing="Mobile no is required*" data-prompt-position="bottomLeft">
                 </div>
                 ...
                 <div class="form-group col-md-6">
                      <label class="label" for="person_to_contact">7. person to contact</label>
                       <div class="input-group">
                          ...
                          <input type="text" name="name" class="form-control validate[required]" placeholder="Ram Lakshman  Das "  data-errormessage-value-missing="Name is required*" data-prompt-position="bottomLeft">
                      </div><!-- /input-group -->
               ...
               <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control validate[required]" name="sales_person" placeholder="Tapas Kumar  Biswas" data-errormessage-value-missing="Sales person name is required*" data-prompt-position="bottomLeft" />
               </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input type="text" class="form-control" name="website" placeholder="www.crispdigitalindia.com" >
            </div>
          </div>
          ...
          <div class="form-row">
               ...
               <div class="form-group col-md-4">
                  <textarea  class="form-control " type="text" name="description_1" data-errormessage-value-missing="Description is required*" data-prompt-position="bottomLeft"></textarea>
               </div>
               <div class="form-group col-md-4">
               ...
               <div class="table table-bordered" style="background-color: rgba(0,0,0,.03);">
                      <div class="row c_row">
                        <div class="col-md-4">CHEQUE DATES</div>
                          <div class="col-md-8">
                            <input  type="text" class="form-control date" id="Txt_Date"  name="c_date" onclick="show_cal(this)" >
                          </div> 
                      </div>
                      ...
                      <div class="row c_row">
                         ...
                         <div class="col-md-8">
                            <textarea  class="form-control " type="text" name="c_no" ></textarea>
                          </div>
                      </div>
                       ...
                       <div class="row c_row">
                          ...
                          <div class="col-md-8">
                              <textarea type="text" class="form-control " name="c_amount" ></textarea>
                          </div>
                      </div>
                      ...
                      <div class="row c_row">
                        ...
                        <div class="col-md-8">
                           <textarea type="text" class="form-control" name="c_manager_name" ></textarea>
                        </div>
                      </div>
            ...
            <div class="form-row">
               <div class="form-group col-md-12">
                  ...
                  <div class="col-md-11" style="padding-left: 20px;color: blue;font-size: 18px;;">
                     <input type="checkbox" required="" style="zoom:1.5" >
             ...
             <div class="form-row">
                ...
                <div class="form-group col-md-6" style="padding:0px 25px;">
                    ...
                    <input type="file" class="validate[required]" name="file_1" id="file_1" accept="image/*" onchange="preview_image(event)" data-errormessage-value-missing="Authorised Signature is required*" data-prompt-position="bottomLeft" >
                     <img id="output_image"/>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="file" class="" name="file_2"  accept="image/*" onchange="preview_image2(event)" data-errormessage-value-missing="Company's Stamp is required*" data-prompt-position="bottomLeft" >
